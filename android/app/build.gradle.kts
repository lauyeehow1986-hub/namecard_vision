...
// Release signing is driven by android/key.properties (never committed). If it
// is absent, the build falls back to debug signing so `flutter run --release`
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "io.github.lauyeehow1986.namecard_vision"
    ...
    buildTypes {
        release {
            ...
            // otherwise fall back to debug signing so release builds still run.
